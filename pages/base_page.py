...
class Page:
    ...
    def verify_text(self, expected_text, *locator):
        ...
        assert expected_text == actual_text, f"Error, '{expected_text}' not in actual {actual_text}"
    ...
    def verify_url(self, expected_url):
        ...
        assert expected_url == actual_url, f"Expected URL '{expected_url}' not in actual URL{actual_url}"


    def verify_partial_url(self, expected_partial_url):
        actual_url = self.driver.current_url
        print('Current URL: ', actual_url)
        assert expected_partial_url in actual_url, f"Expected URL '{expected_partial_url}' not in actual URL{actual_url}"
